<?php include 'partials/header.php'; ?>
    ...
    <section id="main-section">
      <div class="column row expanded home-gallery-title">
        <div class="title-01"><h2>gallery</h2></div>
        <div class="title-02 show-for-large"><h3>Get famous<br><span class="text-alternative"> or die trying</span></h3></div>
      </div>
      <div class="home-gallery expanded row medium-collapse clearfix">
    ...
    <div class="column row expanded home-gallery-title hide-for-large">
      <div class="title-01"><h2>yoshi takashima</h2></div>
    </div>
    <div class="title-04 show-for-large">
      <h3>Style<br><span class="text-alternative">is attitude</span></h3>
    </div>
    <section class="home-yoshi expanded row medium-collapse">
      <div class="home-yoshi-img small-12 medium-6 column">
