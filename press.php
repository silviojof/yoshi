...
<div class="pages-header">
  <div class="pages-header-img">
    <img src="images/header-press.jpg" />
  </div>
  <div class="pages-header-hero clearfix">
    <h1 class="pages-header-title press">press &amp;<br>media</h1>
    <div class="pages-header-box clearfix">
      <h2>Yoshi Hair Studio<br> <span class="text-alternative">on media</span></h2>
      </ul>
    </div>
  </div>
</div>
