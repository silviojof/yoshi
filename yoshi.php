...
<div class="pages-header">
  ...
  <div class="pages-header-hero clearfix">
    <h1 class="pages-header-title yoshi">our salon</h1>
    <div class="pages-header-box clearfix">
      <h2>A little bit<br> <span class="text-alternative">about us</span></h2>
      </ul>
    </div>
  </div>
</div>
...
<div class="cta-box">
  <h4>Get inspired by<span class="text-alternative"><em> our Salon</em></span></h4>
</div>
...
<section class="gallery-box">
  <div class="row expanded small-collapse">
    <div class="small-12 medium-6 large-4 column gallery-img">
      ...
      <img src="images/salon01.jpg" class="thumbnail" alt="">
    </div>
    <div class="small-12 medium-6 large-4 column gallery-img">
      <div class="shadow">
        <p><span class="text-alternative">Yoshi Hair Studio </span><br><a href='contact.php'>Book Now</a></p>
